-- Left column and similiar settings
...
vim.opt.backup = false -- disable backup file creation -- icky swap file stuff
...
vim.opt.fileencoding = "utf-8" -- set file encoding to UTF-8 (standard)
...
vim.opt.writebackup = false -- prevent editing of files being edited else
